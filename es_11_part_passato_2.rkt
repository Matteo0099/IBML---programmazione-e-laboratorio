...
#reader(lib "htdp-intermediate-lambda-reader.ss" "lang")((modname es_9_part_passato_2) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
